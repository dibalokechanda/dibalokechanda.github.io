...
The main reason to come up with the concept with ELBO (at least originally) is due to intractibility of computing distributions in higher dimensions. Let's establish a framework so that we can talk about it more concretely. 
