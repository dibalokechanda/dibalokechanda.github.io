...
Where, $\mathbf{x}=\left[ \begin{aligned} x_1 \\ x_2 \\ . \\ x_n \end{aligned} \right]$ , $\mathbf{\lambda}=\left[ \begin{aligned} \lambda_1 \\ \lambda_2 \\ . \\ \lambda_n \end{aligned} \right]$ and $\mathbf{0}=\left[ \begin{aligned} 0 \\ 0 \\ . \\ 0 \end{aligned} \right]$.
